...
public class Main {
  public static void main(String[] args) {
    ...
    XList<Integer> list6 = XList.ofColl(set);
    ...
    XList<List<List<String>>> cres = toCombine.combine();
    System.out.println(cres);

    // collect i join
    XList<String> j1 = cres.collect( list -> new XList<>(list).join());
    System.out.println(j1.join(" "));
    XList<String> j2 =cres.collect( list -> new XList<>(list).join("-"));
